...
public class TestRegistrationByBrowserstack extends EventsListener {
    ...
    private static final String USERNAME = "asdqwez1";
    private static final String AUTOMATE_KEY = "6YxsnWXE6DgNqhNBcCJr";
